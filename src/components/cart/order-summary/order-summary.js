        ...
        return (
            <div style={{ fontFamily: "serif" }}>
                ...
                <div className="row p-3">
                    ...
                    <button
                        className=" col-2 col-sm-4 col-md-3 btn btn-danger btn-sm text-uppercase"
                        onClick={this.couponCodeCheck}
                        style={{ backgroundColor: "#E2886C", border: "1px solid #E2886C" }}>apply
                    </button>
                </div>
                ...
                <div className="border p-4" style={{ fontFamily: "sans-serif" }}>
                    ...
                    <div className="d-flex justify-content-between mb-3 pt-1 px-2" style={{ backgroundColor: "#99999929" }}>
                        <span className="text-capitalize text-dark">total</span>
                        <span> &#8377;{this.props.total - 300}</span>
                    </div>
                    <button className="btn btn-danger btn-block text-uppercase"
                        style={{ backgroundColor: "#E2886C", border: "1px solid #E2886C" }}>checkout</button>
                </div>
            </div>
        )
    }
